...
`,
  ...
  {
    id: 'ch4',
    title: 'Basic Image Processing & OCR',
    subtitle: 'Signal Acquisition',
    storyBlurb: 'The pipeline needs eyes. Learn to load, manipulate, and read text from images — the manual way — before the real vision model takes over.',
    isBuilt: false,
    missions: [],
  },
  {
    id: 'ch5',
    title: 'Florence-2 Pipeline',
    subtitle: 'Vision Intelligence',
    storyBlurb: 'Upgrade the pipeline. Send ICU images to Florence-2 and extract vitals with a single API call — no thresholds, no regex, no guesswork.',
    isBuilt: false,
    missions: [],
  },
]
